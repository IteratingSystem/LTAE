...
public class LtaePlugin implements ArtemisPlugin {
    ...
    public void setup(WorldConfigurationBuilder worldConfigurationBuilder) {
        ...
        //初始系统
        worldConfigurationBuilder.with(new AssetSystem(ltaeBuilder.getTileMapPath(),ltaeBuilder.getBTreePath()));//资源系统
        ...
        //渲染前更新
        worldConfigurationBuilder.with(new PosFollowBodySystem(ltaeBuilder.getWorldScale())); //坐标跟随物理身体
        ...
        //渲染形状(Debug)
        worldConfigurationBuilder.with(new RenderShapeSystem());
        //创建实体
